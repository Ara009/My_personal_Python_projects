...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value=''
        Entry(width=17,bg='#00ffff',font=("Ariel bold",28),textvariable=self.equation).place(x=0,y=0)

        Button(width=11,height=4, text='(',relief='flat',bg='white',command=lambda: self.show("c")).place(x=0 ,y=50)
